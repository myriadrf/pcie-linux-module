...
#define CSR_PCIE_DMA_READER_CURRENT_PACKET_ADDR(DMA_NR) (0xa82c+0x800*DMA_NR)
#define CSR_PCIE_DMA_READER_CURRENT_PACKET_SIZE 1
#define CSR_PCIE_DMA_READER_TABLE_VALUE_ADDR(DMA_NR) (0xa830+0x800*DMA_NR)  
#define CSR_PCIE_DMA_READER_TABLE_VALUE_SIZE 2
#define CSR_PCIE_DMA_READER_TABLE_WE_ADDR(DMA_NR) (0xa838+0x800*DMA_NR)  
#define CSR_PCIE_DMA_READER_TABLE_WE_SIZE 1
#define CSR_PCIE_DMA_READER_TABLE_LOOP_PROG_N_ADDR(DMA_NR) (0xa83c+0x800*DMA_NR)  
#define CSR_PCIE_DMA_READER_TABLE_LOOP_PROG_N_SIZE 1
#define CSR_PCIE_DMA_READER_TABLE_LOOP_STATUS_ADDR(DMA_NR) (0xa840+0x800*DMA_NR)  
#define CSR_PCIE_DMA_READER_TABLE_LOOP_STATUS_SIZE 1
#define CSR_PCIE_DMA_READER_TABLE_LEVEL_ADDR(DMA_NR) (0xa844+0x800*DMA_NR)  
#define CSR_PCIE_DMA_READER_TABLE_LEVEL_SIZE 1
#define CSR_PCIE_DMA_READER_TABLE_FLUSH_ADDR(DMA_NR) (0xa848+0x800*DMA_NR)  
